...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <body>
    <font align="center"><h1>Member Details</h1></font>
	<?php
   session_start();
          ...
          <div class="dropdown">
            <h1>Menu</h1></br>
              ...
              <div class="dropdown-content">
                <a href="display_member2.php">View</a>
            ...
            <div class="dropdown">
                <br> 
		          ...
		          <div class="dropdown-content">
						<a href="display_staff2.php">View</a>
                  </div>
                </div>
            ...
            <div class="dropdown">
                        <br>
                          ...
                          <div class="dropdown-content">
                            <a href="display_complaints">View</a>
							<a href="Complaints.html">Add</a>
                          </div>
                        </div>
            ...
            <div class="dropdown">
                            <br>
                              ...
                              <div class="dropdown-content">
                                  <a href="display_notice2.php">View</a>
                              </div>
                            </div>
