...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <body>
    <font align="center"><h1>Staff Details</h1></font>
	<?php
   session_start();
   if($_SESSION['staff_user'])
   {
   ?>
	<font align="Right"><h6><?php echo "Welcome   ".$_SESSION['staff_user'] ?></h6></font>
	<?php
   }
	?>
      <div class="sidenav">
          ...
          <div class="dropdown">
            <h1>Menu</h1></br>
              ...
              <div class="dropdown-content">
                <a href="Visitors.html">Add</a>
                <a href="display_visitors.php">View</a>
              </div>
            </div>
                ...
                <br> 
		          ...
		          <div class="dropdown-content">
						<a href="display_member1.php">View</a>
                  </div>
                </div>
            ...
            <div class="dropdown">
                <br> 
		          ...
		          <div class="dropdown-content">
						<a href="display_staff1.php">View</a>
                  </div>
                </div>
                    ...
                    <div class="dropdown">
                        <br>
                          ...
                          <div class="dropdown-content">
                            <a href="display_complaints1.php">View</a>
                          </div>
                        </div>
                        ...
                        <div class="dropdown">
                            <br>
                              ...
                              <div class="dropdown-content">
                                  <a href="display_notice1.php">View</a>
                              </div>
                            </div>
