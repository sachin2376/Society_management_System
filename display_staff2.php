...
<form name="myform" method="post" action="display_Staff2.php" " > 
...
<div class="container">
<table border="2" cellpadding="10" width="100%" height="80px" align="center" background="abc.jpg">
<tr border="1">
	<div class="container">
	<td align="center"><a class="btn" href="left_menu2.php" >BACK</td>
	</div>
	</div>
</tr>
</table>
