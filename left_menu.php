...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <body>
    <font align="center"><h1>Secretary Details</h1></font>

   <?php
   session_start();
   if($_SESSION['secretary_user'])
   {
   ?>
	<font align="Right"><h6><?php echo "Welcome   ".$_SESSION['secretary_user'] ?></h6></font>
	<?php
   }
	?>
      <div class="sidenav">
          ...
          <div class="dropdown">
            <h1>Menu</h1></br>
              ...
              <div class="dropdown-content">
                  <a href="Member.html">Add</a>
                  <a href="update_member.php">Update</a>
                  <a href="display_member.php">Show</a>
              </div>
            </div>
            <div class="dropdown">
                <br> 
                  ...
                  <div class="dropdown-content">
                    <a href="Staff.html">Add</a>
                    <a href="update_staff.php">Update</a>
                    <a href="display_staff.php">Show</a>
                    ...
                    <div class="dropdown">
                        <br> 
                          ...
                          <div class="dropdown-content">
                              <a href="display_complaints.php">Show</a>
                          </div>
                        </div>
                        ...
                        <div class="dropdown">
                            <br>
                              ...
                              <div class="dropdown-content">
                                  <a href="Notice.html">Add</a>
                                  <a href="display_notice.php">Show</a>
                              </div>
                            </div>
