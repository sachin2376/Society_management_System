...
<form name="myform" method="post"  action="display_notice1.php" > 
...
<table border="0" cellpadding="25" width="100%" height="100%" align="center" cellspacing="19" background="a1.jpg">
...
<tr>
	...
	<td><input type="textarea" height="1" name="desc" size="25" value="<?php echo $row['description'];?>"> </td>
</tr>


<tr>
	<td align="right"><b><font face="Comic Sans MS, cursive, sans-serif" size="5%" color="black">Date:-</td></<td></font>
	<td><input type="date" name="date" size="25" value="<?php echo $row['date'];?>"></td>
</tr>


<tr>
	<td align="right"><b><font face="Comic Sans MS, cursive, sans-serif" size="5%" color="black">Date:-</td></<td></font>
	<td><input type="date" name="date" size="25" value="<?php echo $row['staff_id'];?>"></td>
</tr>
...
<div class="container">
<table border="2" cellpadding="10" width="640" height="80px" align="center" background="a1.jpg">
<tr border="1">
	<div class="container">
	...
	<td align="center"><a class="btn"  href="left_menu1.php" value="Back">BACK</td>
	</div>
	</div>
</tr>
</table>
